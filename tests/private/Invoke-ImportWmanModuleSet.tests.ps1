...
Describe "Invoke-ImportWmanModuleSet function for $moduleName" {
    ...
    It "Should not Throw an exception if the source directory does exist." {
        ...
        {Invoke-ImportWmanModuleSet -RestServer localhost -WmanId 1} | Should -Not -Throw
    ...
    It "Should Throw if the Rest Server cannot be reached.." {
        ...
        Mock -CommandName 'Write-LogLevel' -MockWith {}
        {Invoke-ImportWmanModuleSet -RestServer localhost -WmanId 1} | Should -Throw
        Assert-MockCalled -CommandName 'Test-Connection' -Times 3 -Exactly
        Assert-MockCalled -CommandName 'Write-LogLevel' -Times 4 -Exactly
    }
    It "Should not Throw an exception if there are no modules to import." {
        Mock -CommandName 'Test-Connection' -MockWith {
            $true
        }
        Mock -CommandName 'Write-LogLevel' -MockWith {}
